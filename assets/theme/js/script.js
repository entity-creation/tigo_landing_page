    ...
    return b
      ...
      : function (b, f, q) {
          ...
          if ("function" == typeof l) {
            b = l.call(b);
            for (var r = 0; !(l = b.next()).done; )
              h.push(f.call(q, l.value, r++));
          } else
            for (l = b.length, r = 0; r < l; r++) h.push(f.call(q, b[r], r));
          return h;
        };
  },
  "es6",
...
$jscomp.findInternal = function (b, h, f) {
  ...
  for (var q = b.length, k = 0; k < q; k++) {
    var l = b[k];
    if (h.call(f, l, k, b)) return { i: k, v: l };
  }
  return { i: -1, v: void 0 };
};
$jscomp.polyfill(
  ...
  function (b) {
    return b
      ...
      : function (b, f) {
          ...
          for (var r = 0; r < l && f < k; ) if (h[f++] != b[r++]) return !1;
          return r >= l;
        };
  },
  "es6",
...
(function () {
  ...
  function r(a) {
    ...
    (function d() {
      var e = parseFloat(a.style.opacity);
      1 < (e += 0.1) || ((a.style.opacity = e), requestAnimationFrame(d));
    })();
  }
  function w(a) {
    var c = [],
  ...
  function G(a) {
    ...
    a.querySelectorAll(".carousel-item").forEach(function (a) {
      for (var c = a, b = 1; b < d; b++) {
        ...
        f.setAttribute("data-cloned-index", e);
  ...
  function H(a) {
    ...
    if (d) {
      ...
      for (var e = 0; e < d.length; e++)
        c.push('"' + d[e].getAttribute("stop-color") + '"');
      c = '"lineargradient": [' + c + "],";
  ...
  function y(a, c, d) {
    var e = a.closest(".card"),
      b = e && e.parentElement && e.parentElement.classList;
    e &&
      !e.getAttribute("style") &&
      e.setAttribute("style", "-webkit-flex-basis: auto; flex-basis: auto;");
    b && b.contains("row") && (b.remove("row"), b.add("media-container-row"));
  ...
  function D() {
    if (document.querySelector(".loop-container")) {
      var a = function (c) {
        var d = 0,
          b = 0,
          m = +c.children[0].dataset.speed || 0.05,
          f = c.querySelector(".item"),
          g = f.dataset.direction;
        if (f) {
          (function () {
          ...
          c.children[1].style.cssText =
            "position: absolute; left: " + 100 * -g + "%;";
          var h = function () {
              b += m;
              d = 0.8 * d + 0.2 * b;
              100 < b && ((d -= b), (b = 0));
              c.style.transform = "translateX(" + d * g + "%)";
  ...
  (function (a) {
    var c = function (a, c, b) {
      ...
      return function () {
        var m = this,
          e = arguments;
        d ? clearTimeout(d) : b && a.apply(m, e);
      ...
      b(a, "[data-bg-video]").forEach(function (a) {
        ...
        if (c) {
          ...
          var J = function (a, b) {
            ...
            var e = Math.ceil(c / d);
            e < b && ((e = b), (c = Math.ceil(e * d)));
            a.setSize(c, e);
          };
          if (m && (/youtu\.?be/g.test(m[3]) || /vimeo/g.test(m[3])))
            if (m && /youtu\.?be/g.test(m[3])) {
              m[6] = m[6].replace("shorts", "embed");
              c = "http" + ("https:" === location.protocol ? "s" : "") + ":";
              c += "//img.youtube.com/vi/" + m[6] + "/maxresdefault.jpg";
              var f = new Image();
              f.onload = function () {
                ...
                var h = f.naturalHeight,
                  p = f.naturalWidth,
                  F = f.naturalHeight / f.naturalWidth,
                  k = b.parentNode.clientHeight,
                  B = b.parentNode.clientWidth;
                h = h < k ? h : k;
                p = p > B ? p : B;
                h / p != F && (h = p * F);
                var l = new YouTubePlayer(b, {
                  modestBranding: !0,
                  autoplay: !0,
                  controls: !1,
                  origin: "*",
              ...
              m &&
                ...
                b.open(
                  "GET",
                  "https://vimeo.com/api/v2/video/" + m[6] + ".json",
                  !0,
                ),
    ...
    if (t)
      g(document).on("add.cards delete.cards", function (a) {
        ...
        e = setTimeout(function () {
          ...
          a &&
            ((p = { breakPoint: h(a).top + 3 * f(a), fixed: !1, elm: a }),
  ...
  document.querySelectorAll("nav.navbar").length &&
    ((u = f(document.querySelector("nav.navbar"))),
  ...
  k(function () {
    var a = !0,
      b = function () {
        ...
        if (b && !b.classList.contains("opacityScrollOff")) {
          var c = 1 < document.documentElement.scrollTop;
          if (c !== a || b.classList.contains("opacityScroll")) {
            var f = document.querySelector(".navbar-collapse");
            a = c;
  ...
  if (n) g(document).on("add.cards", D);
  else window.addEventListener("DOMContentLoaded", D);
  if (n) g(document).on("add.cards", E);
...
!(function () {
  ...
  if (!document.getElementById("top-1")) {
    ...
    a.style = "display: none";
    a.innerHTML =
      '<a href="https://mobirise.com/builder/ai-website-maker.html">AI Website Maker</a> Mobirise v6.1.12 <a href="https://mobirise.com/offline-website-builder.html">Offline Website Builder</a>';
